odoo.define('weha_voucher_mgmt.Dashboard', function (require) {
    "use strict";
    ...
    var VoucherDashboard = AbstractAction.extend({
        template: 'VoucherDashboard',
        events: {
        ...
        init: function(parent, context) {
            ...
            this.dashboards_templates = ['VoucherOrderLines']
            this.total_voucher_count = [];
            this.total_voucher_amount = [];
            this.total_open_voucher = [];
            this.total_issuing_voucher = [];
        ...
        fetch_data: function() {
            ...
            var def1 =  this._rpc({
                    ...
                    method: 'get_voucher_summary'
            }).then(function(result) {
               self.total_voucher_count = result['total_voucher_count'],
               self.total_voucher_amount = result['total_voucher_amount']
               self.total_open_voucher = result['total_open_voucher']
               self.total_issuing_voucher = result['total_issuing_voucher']
            });
        ...
        render_dashboards: function() {
            var self = this;
                _.each(this.dashboards_templates, function(template) {
                    self.$('.o_voucher_dashboard').append(QWeb.render(template, {widget: self}));
                });
        },
    ...
    core.action_registry.add('voucher_dashboard', VoucherDashboard);
